...
@Injectable()
export class RoomTypeConfigPopupService {
            ...
            if (id) {
                this.roomTypeService.find(id)
                    .subscribe((roomTypeResponse: HttpResponse<RoomTypeConfig>) => {
                        const roomType: RoomTypeConfig = roomTypeResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.roomTypeModalRef(component, new RoomTypeConfig());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    roomTypeModalRef(component: Component, roomType: RoomTypeConfig): NgbModalRef {

...
@Injectable()
export class CustomerTypeModelPopupService {
            ...
            if (id) {
                this.customerTypeService.find(id)
                    .subscribe((customerTypeResponse: HttpResponse<CustomerTypeModel>) => {
                        const customerType: CustomerTypeModel = customerTypeResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.customerTypeModalRef(component, new CustomerTypeModel());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    customerTypeModalRef(component: Component, customerType: CustomerTypeModel): NgbModalRef {

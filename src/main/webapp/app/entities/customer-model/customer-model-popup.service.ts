...
@Injectable()
export class CustomerModelPopupService {
            ...
            if (id) {
                this.customerService.find(id)
                    .subscribe((customerResponse: HttpResponse<CustomerModel>) => {
                        const customer: CustomerModel = customerResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.customerModalRef(component, new CustomerModel());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    customerModalRef(component: Component, customer: CustomerModel): NgbModalRef {

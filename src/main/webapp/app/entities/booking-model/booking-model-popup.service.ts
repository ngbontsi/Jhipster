...
@Injectable()
export class BookingModelPopupService {
            ...
            if (id) {
                this.bookingService.find(id)
                    .subscribe((bookingResponse: HttpResponse<BookingModel>) => {
                        const booking: BookingModel = bookingResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.bookingModalRef(component, new BookingModel());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    bookingModalRef(component: Component, booking: BookingModel): NgbModalRef {

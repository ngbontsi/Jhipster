...
describe('Service Tests', () => {
    ...
    describe('RoomServiceConfig Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RoomServiceConfigService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/room-services';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RoomServiceConfig', () => {
